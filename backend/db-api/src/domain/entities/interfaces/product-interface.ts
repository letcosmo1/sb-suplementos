...
export interface IProductRepository {
  ...
  getProductByTitleAsc(title: title): Promise<IProduct[] | null>;
  getProductByTitleDesc(title: title): Promise<IProduct[] | null>;
  getProductByTitlePriceAsc(title: title): Promise<IProduct[] | null>;
  getProductByTitlePriceDesc(title: title): Promise<IProduct[] | null>;
...
export interface IProductByTitleAsc {
  getProductByTitleAsc(title: title): Promise<IProduct[] | null>;
}
export interface IProductByTitleDesc {
  getProductByTitleDesc(title: title): Promise<IProduct[] | null>;
}
export interface IProductByTitlePriceAsc {
  getProductByTitlePriceAsc(title: title): Promise<IProduct[] | null>;
}
export interface IProductByTitlePriceDesc {
  getProductByTitlePriceDesc(title: title): Promise<IProduct[] | null>;
}
